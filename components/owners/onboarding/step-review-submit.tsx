  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-5">
        ...
        <div className="rounded-[12px] border border-border-default bg-elevated p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs font-sans">
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Business Name</span>
              <span className="text-text-main font-medium mt-0.5 block">{data.business.business_name || "N/A"}</span>
            </div>
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Phone Number</span>
              <span className="text-text-main font-medium mt-0.5 block">{data.business.phone_number || "N/A"}</span>
            </div>
            <div className="md:col-span-2">
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Business Address</span>
            ...
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">GST Number</span>
              <span className="text-text-main font-medium mt-0.5 block">{data.business.gst_number || <span className="text-text-muted italic">Not Provided</span>}</span>
            </div>
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Business PAN</span>
              <span className="text-text-main font-medium mt-0.5 block">{data.business.pan_number || <span className="text-text-muted italic">Not Provided</span>}</span>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-[12px] border border-border-default bg-elevated p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs font-sans">
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Venue Name</span>
              <span className="text-text-main font-medium mt-0.5 block">{data.venue.name || "N/A"}</span>
            </div>
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Price Per Hour</span>
              <span className="text-brand-lime font-bold mt-0.5 block">₹{data.venue.price_per_hour}/hr</span>
            </div>
            <div className="md:col-span-2">
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Venue Address</span>
              <span className="text-text-main font-medium mt-0.5 block">
                {data.venue.address}, {data.venue.city}, {data.venue.state} {data.venue.zip_code ? `- ${data.venue.zip_code}` : ""}
              </span>
            </div>
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Pitches Count</span>
            ...
            {data.venue.amenities && data.venue.amenities.length > 0 && (
              <div className="md:col-span-2">
                <span className="text-text-secondary uppercase font-semibold block tracking-wider mb-1">Amenities</span>
            ...
            <div className="md:col-span-2">
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Venue Photos</span>
        ...
        <div className="rounded-[12px] border border-border-default bg-elevated p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs font-sans">
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Account Holder</span>
              <span className="text-text-main font-medium mt-0.5 block">{data.payout.bank_account_holder_name || "N/A"}</span>
            </div>
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Bank Name</span>
              <span className="text-text-main font-medium mt-0.5 block">{data.payout.bank_name || "N/A"}</span>
            </div>
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">Account Number</span>
              <span className="text-text-main font-mono mt-0.5 block tracking-wide">{obscureAccount(data.payout.bank_account_number)}</span>
            </div>
            <div>
              <span className="text-text-secondary uppercase font-semibold block tracking-wider">IFSC Code</span>
              <span className="text-text-main font-mono mt-0.5 block tracking-wide">{data.payout.bank_ifsc_code || "N/A"}</span>
            </div>
            {data.payout.upi_id && (
              <div>
                <span className="text-text-secondary uppercase font-semibold block tracking-wider">Settlement UPI ID</span>
      ...
      <div className="space-y-4 pt-2">
        <div className="flex items-start gap-3 bg-surface p-3.5 border border-border-default rounded-[10px]">
          ...
          />
          <label htmlFor="agreement_checkbox" className="font-sans text-xs text-text-muted cursor-pointer leading-relaxed select-none">
